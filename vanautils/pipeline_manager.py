...
class PipelineManager:
    ...
    @property
    def lora_scale_base(self):
        return self._lora_scale_base

    @lora_scale_base.setter
    def lora_scale_base(self, lora_scale_base):
        if lora_scale_base != self._lora_scale_base:
            self._lora_scale_base = lora_scale_base
            self._reapply_loras = True
