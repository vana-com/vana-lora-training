...
class FacePainter:
    class Mask:
        ...
        def mask_area(self):
            ...
            mask_dimension = int( mask_dimension + ( 24 - mask_dimension % 8))
    ...
    def paint_faces(
        ...
        for i, mask in enumerate(
            ...
            output = self.pipeline_manager.generate(
                prompt=prompt,
                negative_prompt="frame, mask, ui, ugly, distorted eyes, deformed iris, toothless, squint, deformed iris, deformed pupils, low quality, jpeg artifacts, ugly, mutilated",
